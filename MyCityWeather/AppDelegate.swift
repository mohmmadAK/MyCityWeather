...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = UIColor(red: 23/255, green: 134/255, blue: 10, alpha: 1.0)
        
        
        //Initial App Setup
        
        LocationDetail.initializeService()
        
        if UserDefaults.standard.value(forKey: "mycity_weather.openWeatherMapApiKey") != nil {
